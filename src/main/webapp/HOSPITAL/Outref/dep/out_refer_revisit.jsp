...
<html>
<head>
     <title>Outstation Refer Slip</title>
 ...
 */
        ...
        function fetchEmployeeDetails() {
            ...
            const url = "out_refer_revisit.jsp?action=getEmployee"
        ...
        function toggleDependents() {
            ...
            if (relationType === "dependent" && category !== "Others") {
                ...
                const url = "out_refer_revisit.jsp?action=getDependents"
                    + "&empn=" + encodeURIComponent(empn)
                    + "&category=" + encodeURIComponent(category);
                fetch(url)
                    .then(res => res.text())
        ...
        function fetchDependentDetails() {
            ...
            const url = "out_refer_revisit.jsp?action=getDependentDetails"
                + "&empn=" + encodeURIComponent(empn)
