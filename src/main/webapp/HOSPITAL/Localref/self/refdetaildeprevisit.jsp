    ...
    try 
        {
           ...
           ResultSet rs = stmt.executeQuery("select a.patientname,a.empn,a.sex,a.rel,a.age,b.code,b.doctor_name,c.HCODE,c.HNAME, format(a.refdate,'dd-mmm-yyyy'),format(Now(),'dd-mm-yyyy'),a.disease from LOACALREFDETAIL"+yr+" A, DOCTOR B, LOCALHOSPITAL C WHERE a.DOC=b.CODE and a.SPECIALIST=c.HCODE and a.refno = "+refno);
             if (rs.next())
                {
