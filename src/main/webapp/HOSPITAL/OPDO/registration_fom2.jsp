...
<head>
    ...
    <script>
        ...
        function fetchEmployeeDetails() {
            ...
            const url = "registration_fom2.jsp?action=employee"
        ...
        function fetchDependents() {
            const empn = document.getElementById("empn").value.trim();
            const url = "registration_fom2.jsp?action=dependents"
                + "&empn=" + encodeURIComponent(empn);
        ...
        function fetchDependentDetails() {
            ...
            const url = "registration_fom2.jsp?action=dependentDetails"
                + "&empn=" + encodeURIComponent(empn)
